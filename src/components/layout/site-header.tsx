...
export function SiteHeader() {
  return (
    <header className="sticky top-0 z-50 border-b border-[var(--border-soft)]/70 bg-[var(--surface-canvas-translucent)] backdrop-blur-xl supports-[backdrop-filter]:bg-[rgb(248_240_223_/_72%)]">
