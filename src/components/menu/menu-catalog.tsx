          ...
          {populatedCategories.map((category, index) => (
            <li key={category.id}>
              <a
                ...
                className="nav-link inline-flex min-h-11 items-center whitespace-nowrap rounded-full border border-[var(--border-soft)] bg-[var(--surface-card)] px-4 py-2 text-sm font-bold text-[var(--text-strong)] hover:border-[var(--accent-solid)] hover:bg-[var(--accent-soft)]"
              >
